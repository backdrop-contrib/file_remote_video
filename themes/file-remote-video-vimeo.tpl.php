...
/**
 * Template file for theme('file_vimeo_video').
 *
 * Variables available:
...
?>
<div class="<?php print implode(' ', $classes); ?> file-vimeo-<?php print $id; ?> media-vimeo-<?php print $id; ?>">
